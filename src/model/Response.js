...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/EntityTag', 'model/Link', 'model/Locale', 'model/MediaType', 'model/NewCookie', 'model/StatusType', 'model/URI'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./EntityTag'), require('./Link'), require('./Locale'), require('./MediaType'), require('./NewCookie'), require('./StatusType'), require('./URI'));
  } else {
    // Browser globals (root is window)
    if (!root.RecomaxRestApi) {
      root.RecomaxRestApi = {};
    }
    root.RecomaxRestApi.Response = factory(root.RecomaxRestApi.ApiClient, root.RecomaxRestApi.EntityTag, root.RecomaxRestApi.Link, root.RecomaxRestApi.Locale, root.RecomaxRestApi.MediaType, root.RecomaxRestApi.NewCookie, root.RecomaxRestApi.StatusType, root.RecomaxRestApi.URI);
  }
}(this, function(ApiClient, EntityTag, Link, Locale, MediaType, NewCookie, StatusType, URI) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('location'))
        obj.location = URI.constructFromObject(data['location']);
  ...
  /**
   * @member {module:model/URI} location
   */
