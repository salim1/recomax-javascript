...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.RecomaxRestApi.ResponseEntity = factory(root.RecomaxRestApi.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('statusCodeValue'))
        obj.statusCodeValue = ApiClient.convertToType(data['statusCodeValue'], 'Integer');
    }
    return obj;
  }
  ...
  /**
   * @member {Integer} statusCodeValue
   */
